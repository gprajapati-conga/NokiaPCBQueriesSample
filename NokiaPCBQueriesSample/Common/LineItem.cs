...
namespace Apttus.Lightsaber.Nokia.Common
{
    public class LineItem
    {
        ...
        public string Apttus_Config2__ProductId__r_NokiaCPQ_Item_Type__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_NokiaCPQ_Item_Type__c); } }
        public string Apttus_Config2__ProductId__r_Business_Group__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_Business_Group__c); } }
        public string Apttus_Config2__ProductId__r_NokiaCPQ_Product_Discount_Category__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_NokiaCPQ_Product_Discount_Category__c); } }
        public string Apttus_Config2__OptionId__r_NokiaCPQ_Product_Discount_Category__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Product_Discount_Category__c); } }
        public string Apttus_Config2__ProductId__r_Apttus_Config2__ConfigurationType__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_Apttus_Config2__ConfigurationType__c); } }
        public string Apttus_Config2__OptionId__r_Apttus_Config2__ConfigurationType__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__OptionId__r_Apttus_Config2__ConfigurationType__c); } }
        public string Apttus_Config2__ProductId__r_NokiaCPQ_Classification2__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_NokiaCPQ_Classification2__c); } }
        public string Apttus_Config2__OptionId__r_NokiaCPQ_Classification2__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Classification2__c); } }
        public string Apttus_Config2__OptionId__r_NokiaCPQ_Item_Type__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Item_Type__c); } }
        public string Apttus_Config2__ProductId__r_NokiaCPQ_License_Usage__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_NokiaCPQ_License_Usage__c); } }
        public string Apttus_Config2__OptionId__r_NokiaCPQ_License_Usage__c { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_License_Usage__c); } }
        public string Apttus_Config2__ProductId__r_ProductCode { get { return lineItemModel.GetLookupValue<string>(LineItemRelationshipField.Apttus_Config2__ProductId__r_ProductCode); } }
        ...
        public decimal? Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_India__c { get { return lineItemModel.GetLookupValue<decimal?>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_India__c); } }
        public decimal? Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Asia_Pacific_Japan__c { get { return lineItemModel.GetLookupValue<decimal?>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Asia_Pacific_Japan__c); } }
        public decimal? Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Greater_China__c { get { return lineItemModel.GetLookupValue<decimal?>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Greater_China__c); } }
        public decimal? Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Europe__c { get { return lineItemModel.GetLookupValue<decimal?>(LineItemRelationshipField.Apttus_Config2__OptionId__r_NokiaCPQ_Min_SM_Europe__c); } }
        public decimal? Apttus_Config2__ProductId__r_NokiaCPQ_Maximum_IRP_Discount__c { get { return lineItemModel.GetLookupValue<decimal?>(LineItemRelationshipField.Apttus_Config2__ProductId__r_NokiaCPQ_Maximum_IRP_Discount__c); } }
        ...
        public string Portfolio_from_Quote_Line_Item__c { get { return lineItemModel.Get<string>(LineItemCustomField.Portfolio_from_Quote_Line_Item__c); } }
        public string NokiaCPQ_Configuration_Type__c { get { return lineItemModel.Get<string>(LineItemCustomField.NokiaCPQ_Configuration_Type__c); } }
        public string Quote_Type__c { get { return lineItemModel.Get<string>(LineItemCustomField.Quote_Type__c); } }
        public decimal? NokiaCPQ_Maximum_IRP_Discount__c { get { return lineItemModel.Get<decimal?>(LineItemCustomField.NokiaCPQ_Maximum_IRP_Discount__c); } }
        public bool? NokiaCPQ_Static_Bundle_Option__c { get { return lineItemModel.Get<bool?>(LineItemCustomField.NokiaCPQ_Static_Bundle_Option__c); }}
        public string NokiaCPQ_Category__c { get { return lineItemModel.Get<string>(LineItemCustomField.NokiaCPQ_Category__c); } }
        public decimal? Product_Number_Of_Ports__c { get { return lineItemModel.Get<decimal?>(LineItemCustomField.Product_Number_Of_Ports__c); } }
